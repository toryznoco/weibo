...
- (void)setUpFrame
{
    ...
    CGFloat timeY = CGRectGetMaxY(_nameView.frame) + TRStatusCellMargin * 0.5;
    CGSize timeSize = [status.created_at sizeWithFont:TRTimeFont];
    _timeView.frame = (CGRect){{timeX, timeY}, timeSize};
    
    //  来源
    CGFloat sourceX = CGRectGetMaxX(_timeView.frame) + TRStatusCellMargin;
    CGFloat sourceY = timeY;
    CGSize sourceSize = [status.source sizeWithFont:TRSourceFont];
